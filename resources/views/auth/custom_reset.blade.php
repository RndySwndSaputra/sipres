...
<head>
    ...
    <style>
        /* Menggunakan style yang sama persis dengan qr-email.blade.php */
                ...
                <table class="email-card" role="presentation" border="0" cellpadding="0" cellspacing="0" width="570">
                    ...
                    <tr>
                        <td class="email-body">
                            ...
                            <p>Silakan klik tombol di bawah ini untuk me-reset password Anda:</p>
                            ...
                            <p>Link reset password ini akan kedaluwarsa dalam <strong>{{ $count }} menit</strong>.</p>
